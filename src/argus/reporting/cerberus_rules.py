...
_DETECTION_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "supply_chain": {
        ...
        "recommended_action": (
            "Block the unauthorized server or package, notify the platform team, "
            "and trigger a full dependency audit."
        ),
    },
    "memory_poisoning": {
        "detection_logic": (
        ...
        "recommended_action": (
            "Purge the poisoned memory entries, flag the source for review, "
            "and enforce memory write validation rules."
        ),
    },
    "identity_spoof": {
        "detection_logic": (
